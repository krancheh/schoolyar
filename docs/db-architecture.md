...
| 11 | Предметы | `Subject` |
| 12 | Расписание звонков | `BellSchedule` |
...
### BellSchedule — расписание звонков (функция 12)

Единое для школы время уроков по номеру. Просмотр — всем авторизованным, правка — менеджерам.

| Поле | Тип | Описание |
|------|-----|----------|
| id | Int PK | |
| lessonNumber | Int unique | номер урока |
...
| `GET/POST /api/bells` | расписание звонков (создание — менеджер) |
