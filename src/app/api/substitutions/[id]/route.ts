...
import { UpdateSubstitutionInput, updateSubstitution } from "@entities/substitution/service";

export async function PATCH(request: Request, ctx: RouteContext<"/api/substitutions/[id]">) {
